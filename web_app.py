...
st.markdown(
    ...
    .profile-pic { border-radius: 50%; object-fit: cover; width: 50px; height: 50px; border: 1px solid #eee; }
    .display-name { font-weight: bold; color: #0F1419; }
    .user-handle { color: #536471; font-size: 0.9em; }
    .tweet-text { color: #0F1419; line-height: 1.4; word-break: break-word; margin-top: 4px; }
    </style>
    """,
        ...
        if st.button("ポスト", type="primary", use_container_width=True):
            if tweet_txt.strip():
                db.collection("tweets").add({
                    ...
                    "avatar_data": st.session_state.avatar,
